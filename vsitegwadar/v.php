                    ...
                    <form class="form" name="myForm" method="" action="">
                        <div class="row">
                            <div class="col-md-12" style="background-color:#c42127; color:white;">
                                <h2 style="text-align:center;font-family: 'Titillium Web', sans-serif;font-weight: 700;margin-bottom:10px;margin-top:10px;">RECIEPT GENERATOR FOR GWADAR TOUR</h2>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                        <div class="col-md-4"><label style="margin-top:10px;">Phone No:</label></div>

                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <input type="number" placeholder="03435055882" ng-model="session" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                        <div class="col-md-6"><label style="margin-top:10px;">Gwadar Expedition Charges:</label></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"><label style="margin-top:10px;">Advance:</label></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"><label style="margin-top:10px;">Late Payment Charges / Arrears:</label></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"><label style="margin-top:10px;">Early Bird Discount:</label></div>
                                ...
                                <div class="row">
                                        <div class="col-md-6"><label style="margin-top:10px;">Other Discount:</label></div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="number"  ng-model="waive1" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                <div class="row">
                                        <div class="col-md-6"><label style="margin-top:10px;">Air Ticket Charges: </label></div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="number"  ng-model="tcharge" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                <div class="row">
                                        <div class="col-md-6"><label style="margin-top:10px;">Other Expenses: </label></div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="number"  ng-model="oexp" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="areaID">
                            <div class="row" id="voucherDiv">
                                ...
                                <div style="border:1px dashed black; width:300px;" class="col-md-4">
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-12 text-center"><h4>Gwadar Expedition</h4></div>
                                        </div>
                                        ...
                                        <table border="1" class="tableintable">
                                            ...
                                            <tr>
                                                <td>Gwadar Expedition Charges</td>
                                                <td ng-bind="aFee"></td>
                                            </tr>
                                            <tr>
                                                <td>Advance </td>
                                            ...
                                            <tr>
                                                <td>Late Payment Charges / Arrears</td>
                                                <td ng-bind="fines"></td>
                                            </tr>
                                            <tr>
                                                <td>Early Bird Discount: </td>
                                                <td>(<b ng-bind="waive"></b>)</td>
                                            </tr>
                                            <tr>
                                                <td>Other Discount: </td>
                                                <td>(<b ng-bind="waive1"></b>)</td>
                                            </tr>
                                             <tr>
                                                <td>Air Ticket Charges: </td>
                                                <td><b ng-bind="tcharge"></b></td>
                                            </tr>
                                            <tr>
                                                <td>Other Expenses</td>
                                                <td><b ng-bind="oexp"></b></td>
                                            </tr>
                                            <tr>
                                                <td><b>Total</b></td>
                                                <td><b ng-bind="aFee+cFee+fines+cmCharges+tcharge+oexp+sd+tc-waive-waive1"></b></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="text-decoration:underline;font-size:10pt;">{{aFee+cFee+fines+cmCharges+tcharge+oexp+sd+tc-waive-waive1 | words}} Only</td>
                                            </tr>
                                        </table>
                                        <table>
                                            <tr>
                                        ...
                                        <table>
                                            <tr>
                                                <td>In case of any queries, contact: <a style="font-size:10pt;">payments@obortunity.org</a> Or call at <a style="font-size:10pt;">0317-1541489 / 0333-9628605</a></td>
                                            </tr>
                                        </table>
                                        <hr>
                                        <table>
                            ...
                            <div class="row" id="invoiceDiv">
                                <div style="border:2px solid #c42127; width:300px;" class="col-md-6">
                                    <div class="row" style="border-bottom:2px solid #c42127; padding:5px; background-color:#f1f1f1;">
                                        ...
                                        <div class="col-md-6" style="font-size:14pt;text-align:right; color:#c42127"><b>GWADAR EXPEDITION<br/>INVOICE</b></div>
                                    </div>
                                    ...
                                    <div class="row" style="border-bottom:2px solid #c42127; padding:5px;">
                                            <div class="col-md-12">
                                                <table id="invoicetable">
                                                    ...
                                                    <tr>
                                                        <td>Other Discount: </td>
                                                        <td><b>(<b  style="border:0;padding:0px;" ng-bind="waive1"></b>)</b> </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Air Ticket Charges: </td>
                                                        <td><b ng-bind="tcharge"></b></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size:12pt;"><b ng-bind="aFee+cFee+fines+cmCharges+tcharge+oexp+sd+tc-waive-waive1"></b></td>
                                                    </tr>
                                                </table>
                                    ...
                                    <div class="row" style="border-bottom:2px solid #c42127; padding:5px;">
                                            <div class="col-md-12" style="font-size:8pt;">
                                                ...
                                                - For any queries, contact us at <b>payments@obortunity.org / 0317-1541489 / 0333-9628605</b>
                                                <br/>
                                                - After the deadline, <b>a fine of PKR 100 will be charged per day</b>
                                                <br/>
                                                <b style="font-size:10pt;">Thank you for joining us! Excited to see you soon.</b>
